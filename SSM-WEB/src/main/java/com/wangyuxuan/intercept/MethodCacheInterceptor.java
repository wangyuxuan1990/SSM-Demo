package com.wangyuxuan.intercept;

import com.wangyuxuan.util.RedisUtil;
...
public class MethodCacheInterceptor implements MethodInterceptor {
    ...
    @Value("${com.service.impl.xxxRecordManager}")
    private Long xxxRecordManagerTime; //
    @Value("${com.service.impl.xxxSetRecordManager}")
